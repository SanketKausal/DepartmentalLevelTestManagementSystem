...
public class StudentReport {
	...
	private void initialize() {
		...
		columnNames = new String[] {"Department", "Class", "Subject", "Test", "Name of Student", "Score", "Total Marks" };
		model = new DefaultTableModel();
		model.setColumnIdentifiers(columnNames);
		try {
			DB.res = DB.stt.executeQuery("SELECT student.department, student.class, student.subject, student.test, student.name, student.score, test.total_score  FROM student, test WHERE "
					+ "student.department = test.department AND student.class = test.class AND student.subject = test.subject AND student.test = test.name");
			while(DB.res.next())
			{
				row[0] = DB.res.getString("department");
				row[1] = DB.res.getString("class");
				row[2] = DB.res.getString("subject");
				row[3] = DB.res.getString("test");
				row[4] = DB.res.getString("name");
				row[5] = DB.res.getString("score");
				row[6] = DB.res.getString("total_score");
				model.addRow(row);
			}
		} catch (Exception e1) {
		...
		try {
			DB.res = DB.stt.executeQuery("SELECT DISTINCT department FROM test");
			while(DB.res.next())
			{
	...
	protected void filterTable() {
		if(cmbDepartment.getSelectedIndex() != 0 && cmbClass.getSelectedIndex() != 0 && cmbSubject.getSelectedIndex() != 0 ) 
		{
			model.setRowCount(0);
			try {
				//DB.res = DB.stt.executeQuery("SELECT * FROM student WHERE department = '"+cmbDepartment.getSelectedItem().toString()+"' AND class = '"+cmbClass.getSelectedItem().toString()+"' AND subject = '"+cmbSubject.getSelectedItem().toString()+"'");
				...
				while(DB.res.next())
				{
					if(DB.res.getString("department").matches(cmbDepartment.getSelectedItem().toString()) 
							&& DB.res.getString("class").matches(cmbClass.getSelectedItem().toString())
							&& DB.res.getString("subject").matches(cmbSubject.getSelectedItem().toString()))
					{
						row[0] = DB.res.getString("department");
						row[1] = DB.res.getString("class");
						row[2] = DB.res.getString("subject");
		...
		else if(cmbDepartment.getSelectedIndex() != 0 && cmbClass.getSelectedIndex() != 0 && cmbSubject.getSelectedIndex() == 0 ) 
		{
			...
			try {
				...
				while(DB.res.next())
				{
					if(DB.res.getString("department").matches(cmbDepartment.getSelectedItem().toString()) && DB.res.getString("class").matches(cmbClass.getSelectedItem().toString()))
					{
						row[0] = DB.res.getString("department");
						row[1] = DB.res.getString("class");
						row[2] = DB.res.getString("subject");
		...
		else if(cmbDepartment.getSelectedIndex() != 0 && cmbClass.getSelectedIndex() == 0 && cmbSubject.getSelectedIndex() != 0 ) 
		{
			...
			try {
				...
				while(DB.res.next())
				{
					if(DB.res.getString("department").matches(cmbDepartment.getSelectedItem().toString()) && DB.res.getString("subject").matches(cmbSubject.getSelectedItem().toString()))
					{
						row[0] = DB.res.getString("department");
						row[1] = DB.res.getString("class");
						row[2] = DB.res.getString("subject");
		...
		else if(cmbDepartment.getSelectedIndex() == 0 && cmbClass.getSelectedIndex() != 0 && cmbSubject.getSelectedIndex() != 0 ) 
		{
			...
			try {
				...
				while(DB.res.next())
				{
					if(DB.res.getString("class").matches(cmbClass.getSelectedItem().toString()) && DB.res.getString("subject").matches(cmbSubject.getSelectedItem().toString()))
					{
						row[0] = DB.res.getString("department");
						row[1] = DB.res.getString("class");
						row[2] = DB.res.getString("subject");
		...
		else if(cmbDepartment.getSelectedIndex() == 0 && cmbClass.getSelectedIndex() != 0 && cmbSubject.getSelectedIndex() == 0 ) 
		{
			...
			try {
				...
				while(DB.res.next())
				{
					if(DB.res.getString("class").matches(cmbClass.getSelectedItem().toString()))
					{
						row[0] = DB.res.getString("department");
						row[1] = DB.res.getString("class");
						row[2] = DB.res.getString("subject");
		...
		else if(cmbDepartment.getSelectedIndex() == 0 && cmbClass.getSelectedIndex() == 0 && cmbSubject.getSelectedIndex() != 0 ) 
		{
			...
			try {
				...
				while(DB.res.next())
				{
					if(DB.res.getString("subject").trim().matches(cmbSubject.getSelectedItem().toString().trim()))
					{
						row[0] = DB.res.getString("department");
						row[1] = DB.res.getString("class");
						row[2] = DB.res.getString("subject");
